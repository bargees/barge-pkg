...
PACKAGES := acl alsa-utils bindfs bluez5_utils file git i2c-tools iproute2 ipvsadm \
	libcap libcgroup libfuse locales make mjpg-streamer shadow singularity sshfs su-exec tar tmux \
	tzdata vim
