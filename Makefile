...
PACKAGES := acl alsa-utils bindfs file git i2c-tools iproute2 ipvsadm libcap libcgroup \
	libfuse locales make mjpg-streamer shadow sshfs su-exec tar tmux tzdata vim
