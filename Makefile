...
PACKAGES := acl bindfs criu eudev file git iproute2 ipvsadm libcap libcgroup libfuse locales make \
	mjpg-streamer nodejs shadow sshfs su-exec tar tzdata vim
